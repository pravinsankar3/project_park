...
public class PaymentController {
	...
	public Payment fetchAllPaymentById(@RequestBody long paymentId) throws NoSuchPaymentFoundException {
		return service.findPaymentById(paymentId);
	}

	@GetMapping("{paymentDate}")
	public List<Payment> fetchAllPaymentByDate(@RequestBody Date paymentDate) throws NoSuchPaymentFoundException {
