...
public class VehicleController {
	...
	public Vehicle fetchAllVehiclesByVehicleNumberAndUserId(@PathVariable String vehicleNumber, @PathVariable int userId) throws NoSuchVehicleException {
		return service.findVehicleByVehicleNumber(vehicleNumber, userId);
	}
	
	@DeleteMapping("{vehicleNumber}/{userId}")
	public ResponseEntity<?> removeUsersVehicle(@PathVariable String vehicleNumber, @PathVariable int userId) throws NoSuchVehicleException{
